...
### Skills（按主题分组）
- 平台白名单 / Platform registry: docs/skills/registry.md
...
- 安全护栏核心 / Safety guardrails core: docs/skills/safety-guardrails-core.md
- LLM-as-Judge + NeMo 模板 / LLM-as-Judge & NeMo templates: docs/skills/safety-guardrails-llm-judge.md
- 安全护栏决策树与模板 / Safety guardrails decision tree & templates: docs/skills/safety-guardrails-templates.md
...
- 工业界来源图谱 / Industry source map: docs/skills/industry-source-map.md
- 高级架构模式总览 / Advanced patterns overview: docs/skills/advanced-patterns-overview.md
- 评估体系设计 / Evaluation system design: docs/skills/advanced-patterns-evaluation.md
- 可观测性设计 / Observability design: docs/skills/advanced-patterns-observability.md
- 安全对齐+高级架构 / Safety alignment + advanced architecture: docs/skills/advanced-patterns-safety.md
