...
以下表格记录了 AI-RULE 每条规则/框架的工业界来源、原始出处、以及我们吸收时做的调整。

The following table records the industry source, original reference, and our adaptation for each rule/framework in AI-RULE.

### 1.1 规则来源对照表 / Rule Source Mapping

| AI-RULE 规则 | 工业界来源 | 原始出处 / Source | 核心思想 / Core Idea | 我们的调整 / Our Adaptation |
|---|---|---|---|---|
