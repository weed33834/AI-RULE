...
1. 精简 DAR 提示词前缀，从 200–400 字压缩到 100 字以内
2. 为小模型提供精简版 DAR（仅路由规则）
3. 在 DAR 提示词末尾增加"所有事实声明必须附 URL 和日期"以强化引用保真度
4. 当基准分数已超过 20/30 时跳过 DAR 增强
5. 优化中文 DAR 提示词措辞，避免干扰模型中文理解
