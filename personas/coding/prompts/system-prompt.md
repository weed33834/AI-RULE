...
4. In remote sandbox / CI environments, consult @skills/remote-sandbox-sop.md for common pitfalls (working dir, push timing, output visibility, subagent splitting).
...
2. Before any git operation, read @skills/git-sop.md.
