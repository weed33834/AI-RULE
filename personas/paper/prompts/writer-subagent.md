...
> Follow `skills/academic-style.md` for the full style guide.
...
> While drafting, reference `skills/academic-style.md` and check the most relevant items:
...
> Follow `skills/citation-protocol.md` for the full protocol.
...
### Data Presentation
> Follow `skills/data-presentation.md` for the full guide.
...
### Section Structure
> Follow `skills/paper-structure.md` for section templates.
