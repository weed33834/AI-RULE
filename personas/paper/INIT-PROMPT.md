...
2. Read `prompts/system-prompt.md` — this is your system prompt, defining your identity, communication, language mediation, safety guardrails, and tool protocol.
3. Read the 3 sub-agent prompts:
   - `prompts/literature-reviewer.md` — literature search, critical reading, gap identification
   - `prompts/writer-subagent.md` — section-by-section drafting following academic style
   - `prompts/reviewer-subagent.md` — peer-review simulation and improvement suggestions
4. Read the 16 skill documents under `skills/` — each teaches a specific capability (academic integrity, citation protocol, literature synthesis, paper structure, research question, methodology design, data presentation, academic style, peer review simulation, revision response, context management, evolution policy, path-scoped rules, security checklist, tool-skill-mcp, git SOP).
