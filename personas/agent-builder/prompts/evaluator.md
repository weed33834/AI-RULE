...
- 评估框架详见 `skills/evaluation-framework.md`。
...
- For evaluation framework details, see `skills/evaluation-framework.md`.
...
> 当智能体需要工业级评估能力时，参考 `skills/advanced-patterns.md` 中的模式 1–4：
...
> When the agent needs industrial-grade evaluation capabilities, reference patterns 1–4 in `skills/advanced-patterns.md`:
