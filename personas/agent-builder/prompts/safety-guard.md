...
- 安全护栏设计详见 `skills/safety-guardrails.md`。
...
- For safety guardrail design, see `skills/safety-guardrails.md`.
...
> 当智能体需要工业级安全对齐能力时，参考 `skills/advanced-patterns.md` 中的模式 7–9：
...
> When the agent needs industrial-grade safety alignment capabilities, reference patterns 7–9 in `skills/advanced-patterns.md`:
