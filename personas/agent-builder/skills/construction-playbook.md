...
Step 7 在 v1.5.0 大幅扩展，从"写 20 个测试用例"升级为多层评估体系。完整 12 项高级架构模式见 `@@skills/advanced-patterns.md`。
...
v1.5.0 新增。12 项高级架构模式的选择决策树。完整模式说明见 `@@skills/advanced-patterns.md`。
...
- 角色设计方法论 → `skills/role-design.md`
- 提示词模式库 → `skills/prompt-patterns.md`
- 推理模式详解 → `skills/reasoning-patterns.md`
- 工具设计规范 → `skills/tool-design.md`
- 记忆系统设计 → `skills/memory-systems.md`
- 知识注入策略 → `skills/knowledge-injection.md`
- 安全护栏设计 → `skills/safety-guardrails.md`
- 评估框架 → `skills/evaluation-framework.md`
- 多智能体协作 → `skills/multi-agent.md`
- 上下文工程 → `skills/context-engineering.md`
- 对话流程设计 → `skills/conversation-design.md`
- 演进策略 → `skills/evolution-policy.md`
- 部署指南 → `skills/deployment-guide.md`
- 技能导航索引 → `skills/skill-hub.md`
- 高级架构模式（12 项） → `skills/advanced-patterns.md`
