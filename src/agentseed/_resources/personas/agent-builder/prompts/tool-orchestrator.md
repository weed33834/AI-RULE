...
- 工具设计规范详见 `skills/tool-design.md`。
...
- For tool design specs, see `skills/tool-design.md`.
...
> 当智能体核心能力需要跨平台复用时，参考 `skills/advanced-patterns.md` 中的模式 12：
...
> When the agent's core capabilities need cross-platform reuse, reference pattern 12 in `skills/advanced-patterns.md`:
