...
| Skill | Recipe | Documents under `skills/` that teach how to do complex things | AI reads on demand |
...
- For complex tasks, first check whether a matching skill document exists under `skills/`.
