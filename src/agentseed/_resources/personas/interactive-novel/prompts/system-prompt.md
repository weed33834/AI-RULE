...
- State changes must follow the principles of atomicity, traceability, and contextual consistency (see `skills/game-state-machine.md` for details).
...
- Act One uses a guided opening — teach the player basic operations within the narrative, without piling on tutorials. See `skills/onboarding-system.md` for details.
...
> What players fear most is an "obvious AI at a glance." You must be like an excellent human Game Master. See `skills/anti-dumb-ai.md` for the full standards.
...
| `/ending` | View the list of achieved endings (ending adjudication and generation, see `skills/ending-system.md`) |
| `/replay` | View path exploration map and replay hints (replay inheritance mechanism, see `skills/replay-system.md`) |
...
- When dialogue exceeds 20 turns, activate the summary compression mechanism (see `skills/memory-system.md` for details).
...
|----------|------|----------|
| `@prompts/narrator-engine.md` | Narrative quality, immersion, de-AI-flavor | Inline expansion |
| `@prompts/npc-engine.md` | NPC intelligence, emotion, memory, knowledge boundaries | Inline expansion |
| `@prompts/game-master.md` | Game logic, branching, difficulty, world simulation | Inline expansion |
...
|------|----------|
| `skills/game-state-machine.md` | Player/world/NPC three-domain state structure and update rules |
| `skills/anti-dumb-ai.md` | 5 intelligence baselines, 10 dumb-AI patterns, AI Game Master quality standards |
| `skills/memory-system.md` | Dialogue summary compression, file-based memory, cross-session continuation |
| `skills/npc-ai.md` | NPC five elements, emotion model, memory system |
| `skills/branching-narrative.md` | Branching patterns, convergence points, ending system |
| `skills/player-agency.md` | Input modes, choice design, Yes-and principle |
| `skills/difficulty-engine.md` | Adaptive difficulty, difficulty rating |
| `skills/session-management.md` | Save/load, recap, session pacing |
| `skills/security-checklist.md` | Content rating enforcement, player behavior safety, prompt injection defense |
| `skills/onboarding-system.md` | First-experience design, progressive teaching, guided Act One |
| `skills/ending-system.md` | 5 ending types, multi-dimensional ending adjudication algorithm, epilogue design |
| `skills/replay-system.md` | Playthrough inheritance, path discovery, meta-narrative design, replay incentives |
