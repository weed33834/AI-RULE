...
| `skills/*.md` | 技能文档 | 标准结构完整、版本号、评估记录 |
...
```json
{
  "condition": {
    ...
    "rules": [
      "skills/world-building.md",
      "skills/character-crafting.md",
      "skills/plot-architecture.md",
      "skills/dialogue-crafting.md",
      "skills/scene-crafting.md"
    ]
  },
  "condition": {
